# Copyright (C) 2016  Ioan Eugen Stan <ieugen@netdava.com>
#
...
class S3FS(obnamlib.VirtualFileSystem):

    """A VFS implementation for Amazon S3 compatible filesystems."""
    ...
    def open(self, pathname, mode, bufsize=None):
        ...
        f = S3FSFile(self.join(pathname), mode)
